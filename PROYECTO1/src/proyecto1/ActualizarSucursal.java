...
public class ActualizarSucursal extends JFrame implements ActionListener {
    ...
    public ActualizarSucursal() {
        this.setTitle("Actulizar Sucursal");
        ...
        titulo.setText("Actualizar Datos Sucursales");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == agregar) {
            ...
            PROYECTO1.sucursales[Admin.S] = nuevo;
            this.dispose();
            Admin.tablasucursal();
        }
    }
